...
# #SBATCH --account=notchpeak-shared-short # koper
# #SBATCH -C csl # MAKE SURE TO SET THIS IF USING NOTCHPEAK
#SBATCH -o ./logs_3C/slurm-%A-%a.out-%N # name of the stdout, using the job number (%j) and the first node (%N)
#SBATCH -e ./logs_3C/slurm-%A-%a.err-%N # name of the stderr, using job and first node values
#SBATCH --array=1-32
...
STAT_FILE="../station_lists/station.list.db.3C.2023-01-01.2024-01-01.txt"
